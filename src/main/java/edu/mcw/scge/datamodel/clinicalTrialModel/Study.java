...
public class Study {
    ...
    private edu.mcw.scge.datamodel.clinicalTrialModel.ProtocolSection protocolSection;
    @JsonProperty("derivedSection")
    private edu.mcw.scge.datamodel.clinicalTrialModel.DerivedSection derivedSection;
    @JsonIgnore
    ...
    @JsonProperty("protocolSection")
    public edu.mcw.scge.datamodel.clinicalTrialModel.ProtocolSection getProtocolSection() {
        return protocolSection;
    }

    @JsonProperty("protocolSection")
    public void setProtocolSection(edu.mcw.scge.datamodel.clinicalTrialModel.ProtocolSection protocolSection) {
        this.protocolSection = protocolSection;
    }

    public Study withProtocolSection(edu.mcw.scge.datamodel.clinicalTrialModel.ProtocolSection protocolSection) {
        this.protocolSection = protocolSection;
        return this;
    }
